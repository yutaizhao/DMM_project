...
function [local_list, nb_iter]=LATIN(eles, S, E, A, h, Fd, m, tol)
    k0 = E*A/h;
...
function scalability()
    ...
    for i = 1:length(S_list)
        ...
        [local_list, nb_iter] =LATIN(eles, S, E, A, h, Fd, maxIter, tol);
        u_b = local_list(:, 1);
    ...
    ylabel('Number of LATIN iterations');
    title('LATIN: Scalability');
